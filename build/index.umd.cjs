...
`;
	...
	class DenoiseLerpMaterial extends MaterialBase {
	...
	class WebGLPathTracer {
		...
		constructor( renderer ) {
			...
			this._denoiseBlendTarget = new three.WebGLRenderTarget( 1, 1, {
				format: three.RGBAFormat,
				type: three.FloatType,
				magFilter: three.NearestFilter,
				minFilter: three.NearestFilter,
			...
			this._denoiseLowResTarget = new three.WebGLRenderTarget( 1, 1, {
				format: three.RGBAFormat,
				type: three.FloatType,
				magFilter: three.LinearFilter,
				minFilter: three.LinearFilter,
			...
			this._denoiseLowResBlendTarget = new three.WebGLRenderTarget( 1, 1, {
				format: three.RGBAFormat,
				type: three.FloatType,
				magFilter: three.NearestFilter,
				minFilter: three.NearestFilter,
