...
`;
	...
	class WebGLPathTracer {
		...
		_initDenoise() {
			...
			this._denoiseQuad = new Pass_js.FullScreenQuad( new DenoiseMaterial( {
				map: null,
				transparent: false,
				blending: three.NoBlending,
			} ) );

			this._denoiseBlendQuad = new Pass_js.FullScreenQuad( createDenoiseLerpMaterial() );
			...
			this._denoiseTarget = new three.WebGLRenderTarget( 1, 1, rtOptions );
			this._denoiseBlendTarget = new three.WebGLRenderTarget( 1, 1, rtOptions );
			this._lowResDenoiseTarget = new three.WebGLRenderTarget( 1, 1, rtOptions );
			this._lowResBlendTarget = new three.WebGLRenderTarget( 1, 1, rtOptions );
